    ...
    return (
        <Card className="bg-[#DADADA]">
            <VStack>
                ...
                <Box className="flex flex-col flex-nowrap justify-between gap-4 bg-[#FFFFFF] rounded-[16] mt-[-10] px-4 pb-1">
                    <Text
                        className="self-end mt-1 text-xl"
                        style={{
                    ...
                    <View className="flex-row items-center mt-1 mb-1 gap-2">
                        <Image
                            source={
                    ...
                    <Text
                        className="color-black font-semibold text-2xl"
                        style={{
                            fontFamily: 'Montserrat-SemiBold'
                        }}
                    >
                    ...
                    <Text
                        className="line-clamp-2 overflow-hidden text-ellipsis text-2xl"
                        style={{
                            maxWidth: 320,
                    ...
                    <TouchableOpacity
                        ...
                        style={commonStyles.newscardLongButton}
                    >
                        <Text style={commonStyles.newscardButtonText}>
                            Read More
                        </Text>
                    </TouchableOpacity>
                </Box>
